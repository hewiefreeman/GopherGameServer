...
Gopher Game Server provides a flexible and diverse set of tools that greatly ease the development of any type of online multiplayer game, or real-time application. GGS does all the heavy lifting for you, ensuring you never need to worry about synchronizing or data type conversions.
...
-   The server saves the state on shut-down and restores it on reboot (***2**)
...
[🔖 Wiki Home](https://github.com/hewiefreeman/GopherGameServer/wiki)
...
1.  [**Rooms**](https://github.com/hewiefreeman/GopherGameServer/wiki/Rooms)
...
1.  [**Users**](https://github.com/hewiefreeman/GopherGameServer/wiki/Users)
...
1.  [**Custom Client Actions**](https://github.com/hewiefreeman/GopherGameServer/wiki/Custom-Client-Actions)
...
1.  [**Saving & Restoring**](https://github.com/hewiefreeman/GopherGameServer/wiki/Saving-&-Restoring)

-   [Set-Up](https://github.com/hewiefreeman/GopherGameServer/wiki/Saving-&-Restoring#blue_book-set-up)

1.  [**SQL Features**](https://github.com/hewiefreeman/GopherGameServer/wiki/SQL-Features)
...
-   [Contribution Guidelines](https://github.com/hewiefreeman/GopherGameServer/blob/master/CONTRIBUTING.md)
-   [Code of Conduct](https://github.com/hewiefreeman/GopherGameServer/blob/master/CODE_OF_CONDUCT.md)

###### GopherGameServer and all of its contents Copyright 2022 Dominique Debergue
